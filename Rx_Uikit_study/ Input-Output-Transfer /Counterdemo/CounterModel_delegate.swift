...
class CounterViewModel {
    ...
    private(set) var counter: Int = 0 {
        didSet {
            ...
            delegate?.counterViewModel(self, didUpdateCanDecrement: canDecrement())
        }
    }
...
class CounterViewController: UIViewController, CounterViewModelDelegate {
    ...
    // MARK: - CounterViewModelDelegate 方法
    func counterViewModel(_ viewModel: CounterViewModel, didUpdateCounterText text: String) {

...
// ViewController
class Mini_PublishViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let viewModel = Mini_PublisViewModel(inputText: textField.rx.text.orEmpty.asObservable())
